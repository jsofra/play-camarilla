...
return [(function (){var pred__12381 = cljs.core.instance_QMARK_;
var expr__12382 = reactive_val;
if(cljs.core.truth_(pred__12381.call(null,reagent.ratom.RAtom,expr__12382))){
return "ra";
} else {
if(cljs.core.truth_(pred__12381.call(null,reagent.ratom.RCursor,expr__12382))){
return "rc";
} else {
if(cljs.core.truth_(pred__12381.call(null,reagent.ratom.Reaction,expr__12382))){
return "rx";
} else {
if(cljs.core.truth_(pred__12381.call(null,reagent.ratom.Track,expr__12382))){
return "tr";
} else {
return "other";
}
