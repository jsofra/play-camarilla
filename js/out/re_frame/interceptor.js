...
var len__4730__auto___12916 = arguments.length;
var i__4731__auto___12917 = (0);
while(true){
if((i__4731__auto___12917 < len__4730__auto___12916)){
args__4736__auto__.push((arguments[i__4731__auto___12917]));

var G__12918 = (i__4731__auto___12917 + (1));
i__4731__auto___12917 = G__12918;
continue;
} else {
}
break;
...
re_frame.interceptor.__GT_interceptor.cljs$core$IFn$_invoke$arity$variadic = (function (p__12913){
var map__12914 = p__12913;
var map__12914__$1 = (((((!((map__12914 == null))))?(((((map__12914.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__12914.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__12914):map__12914);
var m = map__12914__$1;
var id = cljs.core.get.call(null,map__12914__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var before = cljs.core.get.call(null,map__12914__$1,new cljs.core.Keyword(null,"before","before",-1633692388));
var after = cljs.core.get.call(null,map__12914__$1,new cljs.core.Keyword(null,"after","after",594996914));
if(re_frame.interop.debug_enabled_QMARK_){
var temp__5718__auto___12919 = cljs.core.seq.call(null,clojure.set.difference.call(null,cljs.core.set.call(null,cljs.core.keys.call(null,m)),re_frame.interceptor.mandatory_interceptor_keys));
if(temp__5718__auto___12919){
var unknown_keys_12920 = temp__5718__auto___12919;
re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"error","error",-978969032),"re-frame: ->interceptor",m,"has unknown keys:",unknown_keys_12920);
} else {
}
} else {
}
...
/** @this {Function} */
re_frame.interceptor.__GT_interceptor.cljs$lang$applyTo = (function (seq12912){
var self__4718__auto__ = this;
return self__4718__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq12912));
});
...
/** @this {Function} */
re_frame.interceptor.update_coeffect.cljs$lang$applyTo = (function (seq12927){
...
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12928,G__12929,G__12930,seq12927__$3);
});
...
var G__12934 = re_frame.interceptor.invoke_interceptor_fn.call(null,cljs.core.assoc.call(null,context__$1,new cljs.core.Keyword(null,"queue","queue",1455835879),cljs.core.pop.call(null,queue),new cljs.core.Keyword(null,"stack","stack",-793405930),cljs.core.conj.call(null,stack,interceptor)),interceptor,direction);
context__$1 = G__12934;
continue;
}
break;
}
