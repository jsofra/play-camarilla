...
camarilla.rules.deal_cards = (function camarilla$rules$deal_cards(p__13373,player){
...
var table = map__13374__$1;
var hand_counts = cljs.core.get.call(null,map__13374__$1,new cljs.core.Keyword(null,"hand-counts","hand-counts",-1390565069));
var kings_domain = cljs.core.get.call(null,map__13374__$1,new cljs.core.Keyword(null,"kings-domain","kings-domain",1340864154));
return cljs.core.update.call(null,cljs.core.assoc_in.call(null,table,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"players","players",-1361554569),player], null),cljs.core.reduce_kv.call(null,((function (map__13374,map__13374__$1,table,hand_counts,kings_domain){
...
});})(map__13374,map__13374__$1,table,hand_counts,kings_domain))
,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"dir","dir",1734754661),player], null),kings_domain)),new cljs.core.Keyword(null,"kings-domain","kings-domain",1340864154),((function (map__13374,map__13374__$1,table,hand_counts,kings_domain){
return (function (p1__13372_SHARP_){
return cljs.core.reduce_kv.call(null,((function (map__13374,map__13374__$1,table,hand_counts,kings_domain){
return (function (m,k,cards){
var temp__5718__auto__ = cljs.core.get.call(null,hand_counts,k);
if(cljs.core.truth_(temp__5718__auto__)){
var n = temp__5718__auto__;
...
,cljs.core.PersistentArrayMap.EMPTY,p1__13372_SHARP_);
});})(map__13374,map__13374__$1,table,hand_counts,kings_domain))
);
});
camarilla.rules.init_law_sides = (function camarilla$rules$init_law_sides(kings_domain){
return cljs.core.update.call(null,kings_domain,new cljs.core.Keyword(null,"lawcards","lawcards",1643536535),(function (p1__13376_SHARP_){
...
}),cljs.core.PersistentArrayMap.EMPTY,p1__13376_SHARP_);
}));
});
...
}),cljs.core.update.call(null,cljs.core.update.call(null,table,new cljs.core.Keyword(null,"kings-domain","kings-domain",1340864154),camarilla.rules.shuffle_cards),new cljs.core.Keyword(null,"kings-domain","kings-domain",1340864154),camarilla.rules.init_law_sides),camarilla.rules.players),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"players","players",-1361554569),new cljs.core.Keyword(null,"N","N",-640629860)], null),cljs.core.assoc,new cljs.core.Keyword(null,"turn","turn",75759344),true),new cljs.core.Keyword(null,"current-turn","current-turn",-593026573),new cljs.core.Keyword(null,"N","N",-640629860)),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"kings-domain","kings-domain",1340864154),new cljs.core.Keyword(null,"discarded-actions","discarded-actions",-843821114)], null),cljs.core.PersistentVector.EMPTY);
});
camarilla.rules.active_player_take_action_card = (function camarilla$rules$active_player_take_action_card(p__13378){
var map__13379 = p__13378;
var map__13379__$1 = (((((!((map__13379 == null))))?(((((map__13379.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__13379.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__13379):map__13379);
var table = map__13379__$1;
var kings_domain = cljs.core.get.call(null,map__13379__$1,new cljs.core.Keyword(null,"kings-domain","kings-domain",1340864154));
...
var G__13381 = cljs.core.update_in.call(null,cljs.core.update_in.call(null,table,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"kings-domain","kings-domain",1340864154),new cljs.core.Keyword(null,"actioncards","actioncards",-2013329382)], null),((function (map__13379,map__13379__$1,table,kings_domain){
return (function (p1__13377_SHARP_){
return cljs.core.drop.call(null,(1),p1__13377_SHARP_);
});})(map__13379,map__13379__$1,table,kings_domain))
...
return cljs.core.update_in.call(null,cljs.core.update_in.call(null,table,from_path,(function (p1__13382_SHARP_){
return camarilla.rules.remove_card.call(null,p1__13382_SHARP_,idx);
...
var new_titles = cljs.core.shuffle.call(null,cljs.core.concat.call(null,cljs.core.mapcat.call(null,(function (p1__13383_SHARP_){
return cljs.core.get_in.call(null,table,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"players","players",-1361554569),p1__13383_SHARP_,new cljs.core.Keyword(null,"titlecards","titlecards",-1221765024)], null));
...
return cljs.core.drop.call(null,(1),p1__13384_SHARP_);
});})(new_titles))
);
});})(new_titles))
...
return cljs.core.not_EQ_.call(null,p1__13385_SHARP_,current_turn);
});})(current_turn))
,cljs.core.cycle.call(null,camarilla.rules.players)));
return cljs.core.update_in.call(null,cljs.core.update_in.call(null,cljs.core.assoc_in.call(null,cljs.core.update_in.call(null,cljs.core.assoc.call(null,table,new cljs.core.Keyword(null,"current-turn","current-turn",-593026573),next_dir),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"players","players",-1361554569),current_turn], null),cljs.core.dissoc,new cljs.core.Keyword(null,"turn","turn",75759344)),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"players","players",-1361554569),next_dir,new cljs.core.Keyword(null,"turn","turn",75759344)], null),true),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"players","players",-1361554569),current_turn,new cljs.core.Keyword(null,"actioncards","actioncards",-2013329382)], null),((function (current_turn,next_dir){
return (function (p1__13386_SHARP_){
return cljs.core.remove.call(null,new cljs.core.Keyword(null,"played","played",-1713723590),p1__13386_SHARP_);
...
return cljs.core.dissoc.call(null,p1__13387_SHARP_,new cljs.core.Keyword(null,"played","played",-1713723590));
});})(current_turn,next_dir))
