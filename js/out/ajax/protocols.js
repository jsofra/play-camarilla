...
ajax.protocols.Response.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4387__auto__,k9953,else__4388__auto__){
var self__ = this;
var this__4387__auto____$1 = this;
var G__9957 = k9953;
var G__9957__$1 = (((G__9957 instanceof cljs.core.Keyword))?G__9957.fqn:null);
switch (G__9957__$1) {
case "status":
...
break;
default:
return cljs.core.get.call(null,self__.__extmap,k9953,else__4388__auto__);
...
return (function (ret__4407__auto__,p__9958){
var vec__9959 = p__9958;
var k__4408__auto__ = cljs.core.nth.call(null,vec__9959,(0),null);
var v__4409__auto__ = cljs.core.nth.call(null,vec__9959,(1),null);
...
ajax.protocols.Response.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__9952){
var self__ = this;
var G__9952__$1 = this;
return (new cljs.core.RecordIter((0),G__9952__$1,5,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"status","status",-1997798413),new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator.call(null,self__.__extmap):cljs.core.nil_iter.call(null))));
});
...
ajax.protocols.Response.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this9954,other9955){
var self__ = this;
var this9954__$1 = this;
return (((!((other9955 == null)))) && ((this9954__$1.constructor === other9955.constructor)) && (cljs.core._EQ_.call(null,this9954__$1.status,other9955.status)) && (cljs.core._EQ_.call(null,this9954__$1.body,other9955.body)) && (cljs.core._EQ_.call(null,this9954__$1.status_text,other9955.status_text)) && (cljs.core._EQ_.call(null,this9954__$1.headers,other9955.headers)) && (cljs.core._EQ_.call(null,this9954__$1.was_aborted,other9955.was_aborted)) && (cljs.core._EQ_.call(null,this9954__$1.__extmap,other9955.__extmap)));
});
...
ajax.protocols.Response.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4392__auto__,k__4393__auto__,G__9952){
var self__ = this;
var this__4392__auto____$1 = this;
var pred__9962 = cljs.core.keyword_identical_QMARK_;
var expr__9963 = k__4393__auto__;
if(cljs.core.truth_(pred__9962.call(null,new cljs.core.Keyword(null,"status","status",-1997798413),expr__9963))){
return (new ajax.protocols.Response(G__9952,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__9962.call(null,new cljs.core.Keyword(null,"body","body",-2049205669),expr__9963))){
return (new ajax.protocols.Response(self__.status,G__9952,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__9962.call(null,new cljs.core.Keyword(null,"status-text","status-text",-1834235478),expr__9963))){
return (new ajax.protocols.Response(self__.status,self__.body,G__9952,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__9962.call(null,new cljs.core.Keyword(null,"headers","headers",-835030129),expr__9963))){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,G__9952,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__9962.call(null,new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828),expr__9963))){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,G__9952,self__.__meta,self__.__extmap,null));
} else {
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__4393__auto__,G__9952),null));
}
}
}
}
...
ajax.protocols.Response.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4384__auto__,G__9952){
var self__ = this;
var this__4384__auto____$1 = this;
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,G__9952,self__.__extmap,self__.__hash));
});
 ...
 */
ajax.protocols.map__GT_Response = (function ajax$protocols$map__GT_Response(G__9956){
var extmap__4424__auto__ = (function (){var G__9965 = cljs.core.dissoc.call(null,G__9956,new cljs.core.Keyword(null,"status","status",-1997798413),new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828));
if(cljs.core.record_QMARK_.call(null,G__9956)){
return cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,G__9965);
} else {
return G__9965;
}
})();
return (new ajax.protocols.Response(new cljs.core.Keyword(null,"status","status",-1997798413).cljs$core$IFn$_invoke$arity$1(G__9956),new cljs.core.Keyword(null,"body","body",-2049205669).cljs$core$IFn$_invoke$arity$1(G__9956),new cljs.core.Keyword(null,"status-text","status-text",-1834235478).cljs$core$IFn$_invoke$arity$1(G__9956),new cljs.core.Keyword(null,"headers","headers",-835030129).cljs$core$IFn$_invoke$arity$1(G__9956),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828).cljs$core$IFn$_invoke$arity$1(G__9956),null,cljs.core.not_empty.call(null,extmap__4424__auto__),null));
});
