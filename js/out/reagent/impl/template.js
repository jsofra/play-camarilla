...
var G__12214 = o;
(G__12214[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
var G__12218 = o;
(G__12218[reagent.impl.template.cached_custom_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
var G__12223 = props;
var G__12223__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__12223,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__12223);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__12223__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__12224){
...
var props = map__12225__$1;
var class$ = cljs.core.get.call(null,map__12225__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
if(cljs.core.coll_QMARK_.call(null,class$)){
return cljs.core.assoc.call(null,props,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.call(null," ",cljs.core.keep.call(null,((function (map__12225,map__12225__$1,props,class$){
return (function (c){
...
});})(map__12225,map__12225__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__12227){
...
var on_write = cljs.core.get.call(null,map__12228__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render.call(null,((function (node_value,map__12228,map__12228__$1,on_write){
return (function (){
return reagent.impl.template.input_component_set_value.call(null,component);
});})(node_value,map__12228,map__12228__$1,on_write))
);
} else {
...
var G__12231 = jsprops;
(G__12231["defaultValue"] = value);

(G__12231["onChange"] = ((function (G__12231,v,value,on_change){
return (function (p1__12230_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__12230_SHARP_);
});})(G__12231,v,value,on_change))
);
...
var vec__12234 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__12234,(0),null);
var id = cljs.core.nth.call(null,vec__12234,(1),null);
var class$ = cljs.core.nth.call(null,vec__12234,(2),null);
...
var jsprops = ({"argv": v});
var temp__5724__auto___12238 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5724__auto___12238 == null)){
} else {
var key_12239 = temp__5724__auto___12238;
...
var temp__5724__auto___12240 = reagent.impl.template.key_from_vec.call(null,argv);
if((temp__5724__auto___12240 == null)){
} else {
var key_12241 = temp__5724__auto___12240;
reagent.impl.template.oset.call(null,jsprops,"key",key_12241);
}
...
var G__12242 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__12242["name"] = c);
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq12246){
var G__12247 = cljs.core.first.call(null,seq12246);
var seq12246__$1 = cljs.core.next.call(null,seq12246);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12247,seq12246__$1);
});
...
break;
default:
var G__12253 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
v = G__12253;
continue;
...
var n__4607__auto___12255 = a.length;
var i_12256 = (0);
while(true){
if((i_12256 < n__4607__auto___12255)){
(a[i_12256] = reagent.impl.template.as_element.call(null,(a[i_12256])));
...
var a = cljs.core.into_array.call(null,s);
var n__4607__auto___12258 = a.length;
var i_12259 = (0);
while(true){
if((i_12259 < n__4607__auto___12258)){
var val_12260 = (a[i_12259]);
if(((cljs.core.vector_QMARK_.call(null,val_12260)) && ((reagent.impl.template.key_from_vec.call(null,val_12260) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_12259] = reagent.impl.template.as_element.call(null,val_12260));
...
var ctx = ({});
var vec__12262 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__12262,(0),null);
var derefed = cljs.core.nth.call(null,vec__12262,(1),null);
...
var G__12265 = (cljs.core.count.call(null,argv) - first_child);
switch (G__12265) {
case (0):
...
break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv.call(null,((function (G__12265){
